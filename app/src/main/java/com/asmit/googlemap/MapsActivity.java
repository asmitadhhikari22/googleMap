...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        List<latLang> latLngs = new ArrayList<>();
        latLngs.add(new latLang(27.7052354, 85.3284158, "Mero College"));
        latLngs.add(new latLang(27.70482, 85.3293997, "KKFC"));
...
/*
        // Add a marker in Nepal and move the camera
